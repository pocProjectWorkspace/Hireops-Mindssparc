...
/**
 * Per-route error boundary for /admin/email-templates server-component failures
 * (e.g. a getEmailTemplateCatalog rejection). Reset re-renders the segment.
 */
  ...
  return (
    <main className="mx-auto mt-12 max-w-prose rounded-md border border-status-error-500 bg-status-error-50 p-6">
      ...
      <p className="mb-4 text-sm text-neutral-700">
        We hit an error fetching this tenant&apos;s email copy overrides. Try again, or sign out and
