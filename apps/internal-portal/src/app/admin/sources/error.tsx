...
/**
 * Per-route error boundary for /admin/sources server-component failures
 * (e.g. a listTenantSources rejection). Reset re-renders the segment.
 */
  ...
  return (
    <main className="mx-auto mt-12 max-w-prose rounded-md border border-status-error-500 bg-status-error-50 p-6">
      <h1 className="mb-2 text-xl font-semibold text-status-error-700">
        Couldn&apos;t load the sourcing-channel registry
      </h1>
      <p className="mb-4 text-sm text-neutral-700">
        We hit an error fetching this tenant&apos;s configured sources. Try again, or sign out and
