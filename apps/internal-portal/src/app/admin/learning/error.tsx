...
/**
 * Per-route error boundary for /admin/learning server-component failures (e.g.
 * a listLearningResources rejection). Reset re-renders.
 */
  ...
  return (
    <main className="mx-auto mt-12 max-w-prose rounded-md border border-status-error-500 bg-status-error-50 p-6">
      <h1 className="mb-2 text-xl font-semibold text-status-error-700">
        Couldn&apos;t load the learning configuration
      </h1>
      <p className="mb-4 text-sm text-neutral-700">
        We hit an error fetching this tenant&apos;s learning catalogue and tracks. Try again, or
