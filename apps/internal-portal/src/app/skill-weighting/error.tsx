...
/** Per-route error boundary for /skill-weighting server-component failures. */
export default function SkillWeightingError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[skill-weighting error]", error);
  }, [error]);
