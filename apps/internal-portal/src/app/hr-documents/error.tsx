...
/** Per-route error boundary for /hr-documents server-component failures. */
export default function HrDocumentsError({
  error,
  reset,
}: {
  ...
  return (
    <main className="mx-auto mt-12 max-w-prose rounded-md border border-status-error-500 bg-status-error-50 p-6">
      ...
      <p className="mb-4 text-sm text-neutral-700">
        We hit an error fetching document requests. Try again, or sign out and back in if it
        persists.
      </p>
      <button
        type="button"
