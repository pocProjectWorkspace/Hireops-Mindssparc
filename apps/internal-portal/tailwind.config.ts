  ...
  theme: {
    extend: {
      colors: {
        ...
        // DESIGN-05 dark application chrome (AppShell sidebar).
        sidebar: {
      ...
      // DESIGN-05 `card` level is the soft resting lift for elevated cards;
      // levels 2/3 stay for genuinely floating surfaces (drawers, menus).
      boxShadow: {
        1: "var(--elevation-1)",
        2: "var(--elevation-2)",
        3: "var(--elevation-3)",
